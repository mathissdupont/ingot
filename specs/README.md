...
| [`language/v0.3.md`](language/v0.3.md) | Draft, implemented | Language 0.2 plus `consult`, a question put to a person, and the `human` effect |
| [`language/v0.4.md`](language/v0.4.md) | Draft, implemented | Language 0.3 plus `else`, a value to use when an attempt fails |
...
| [`ir/v0.3.md`](ir/v0.3.md) | Draft, implemented | Agent IR 0.2 plus the `consult` node and the `human` effect |
| [`ir/v0.4.md`](ir/v0.4.md) | Draft, implemented | Agent IR 0.3 plus an optional `fallback` on a call node |
...
| [`runtime/v0.7.md`](runtime/v0.7.md) | Draft, implemented | Runtime 0.6 plus a failure a fallback may absorb, and the closed list of what it may not |
| [`tools/mcp-v0.1.md`](tools/mcp-v0.1.md) | Draft, implemented | The original MCP tool binding |
